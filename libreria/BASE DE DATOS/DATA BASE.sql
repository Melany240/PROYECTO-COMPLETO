...
-- Volcando datos para la tabla libreria.autores: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla libreria.libros: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla libreria.libros_prestados: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla libreria.migrations: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla libreria.users: ~3 rows (aproximadamente)
